...
# Help-call lines. Slack release-notes vibe — admit the problem first,
# tiny self-deprecating aside, never demanding. Mirrors lines like
# "We've got the popsicles. We just need an internet connection."
HELP_PHRASES = {
    "energetic": [
        "あれっ、これどうしよう",
        "ちょっと止まっちゃった、来てもらえる？",
...
# Final-bell lines on Stop, per personality. Slack release-notes vibe —
# quiet satisfaction with a tiny aside ("（汗だく）", "（おやすみなさい）"),
